Public Class Form1
    ...
    '--button hides this form and switches to the future value form
    Private Sub btnFutureValueForm_Click(sender As Object, e As EventArgs) Handles btnFutureValueForm.Click
        Form5.Show()
        Me.Hide()
    End Sub

    '--button hides this form and switches to the present value form
    Private Sub btnPresentValueForm_Click(sender As Object, e As EventArgs) Handles btnPresentValueForm.Click
        Form6.Show()
        Me.Hide()
    End Sub
