...
Public Class Form3
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lsvStocks.Columns.Add("Time", 150, HorizontalAlignment.Left) 'Column 3
        lsvStocks.Columns.Add("Name", 250, HorizontalAlignment.Left) 'Column 4
        lsvStocks.Columns.Add("Placeholder 5", 100, HorizontalAlignment.Left) 'Column 5
        lsvStocks.Columns.Add("Placeholder 6", 100, HorizontalAlignment.Left) 'Column 6
        lsvStocks.Columns.Add("Placeholder 7", 100, HorizontalAlignment.Left) 'Column 7
        lsvStocks.Columns.Add("Placeholder 8", 100, HorizontalAlignment.Left) 'Column 8
    End Sub
